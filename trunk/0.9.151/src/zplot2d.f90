...
complex(8), allocatable :: zfp(:,:)

if ((nf.lt.1).or.(nf.gt.4)) then
  write(*,*)
  write(*,'("Error(zplot2d): invalid number of functions : ",I8)') nf
  write(*,*)
  stop
end if
...
do ip2=0,np2d(2)-1
  do ip1=0,np2d(1)-1
    ...
    write(fnum,'(6G18.10)') t3,t4,(ABS(zfp(ip,i)),i=1,nf)
  end do
end do
deallocate(vpl,zfp)
return

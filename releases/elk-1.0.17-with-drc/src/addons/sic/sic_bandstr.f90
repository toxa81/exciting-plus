...
implicit none
! local variables
integer lmax,lmmax,l,m,lm,ikloc
...
call init1
if (.not.sic) then
  write(*,'("Error(sic_bandstr): SIC correction is switched off")')
  call pstop
endif
...
call mpi_grid_reduce(e(1,1),nstsv*nkpt,dims=(/dim_k/))

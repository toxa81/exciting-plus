...
if (wproc) then
  ...
  sz=16*sz*ntrloc*nspinor*(nwann+2)/1024/1024
  write(151,*)
...
if (wproc) then
  write(151,'("Hartree energy : ")')
  do n=1,nwann
    write(151,'(" n : ",I4,"  e : ",2G18.10)')n,dreal(ehart(n)),dimag(ehart(n))
  enddo
  write(151,*)
  call flushifc(151)
  close(151)
...
!do n=1,nwann
!  do ispn=1,nspinor
!    call lf_prod(vwanmt(1,1,1,1,ispn,n),vwanir(1,1,ispn,n),&
!      wanmt(1,1,1,1,ispn,n),wanir(1,1,ispn,n),&
!      vwanmt(1,1,1,1,ispn,n),vwanir(1,1,ispn,n))
!  enddo
!enddo
